...
public class StudentRepositoryTest {
	 ...
	 * @Test
	 * 
	 * @DirtiesContext public void deleteByIdTest() { courserepo.deleteById(10002L);
	 * assertNull(courserepo.findById(10002L)); }
	 * 
	 * @Test
	 * 
	 * @DirtiesContext public void save() { // get the course Course course =
	 * courserepo.findById(10001L); assertEquals("Java EE", course.getName()); //
	 * up[date the details of course course.setName("Selenium updated");
	 * courserepo.save(course); // check the value Course course1 =
	 * courserepo.findById(10001L); assertEquals("Selenium updated",
	 * course1.getName());
	 * 
	 * // assertNull(courserepo.findById(10002L)); }
	 * 
